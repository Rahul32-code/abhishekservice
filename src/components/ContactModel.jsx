          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                return (
                  <div key={name}>
                    ...
                    <input
                      ...
                      pattern={pattern}
                      placeholder={
                        name === "phone" ? "Enter 10-digit mobile number" : ""
                      }
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2 px-4 bg-indigo-600 cursor-pointer hover:bg-indigo-700 text-white font-semibold rounded-md flex items-center justify-center"
              >
